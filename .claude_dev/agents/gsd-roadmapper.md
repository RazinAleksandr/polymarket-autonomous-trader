...
Reference full template: `/home/trader/polymarket-agent/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/trader/polymarket-agent/.claude/get-shit-done/templates/state.md`.
